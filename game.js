(() => {
  ...
  function drawPrePiece(type, x, y, scale, color) {
    ...
    if (!image) {
      image = new Image();
      let svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1760 1600"><g transform="translate(0 1300) scale(1 -1)" fill="' + color + '"><path d="' + (preSvgShapes[type] || preSvgShapes.pawn) + '"/></g></svg>';
